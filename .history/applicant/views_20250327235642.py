...
from .forms import ApplicationForm  # Assuming you have a form for the application
...
def apply_on_job(request, job_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            application.applicant_name = request.user.first_name + " " + request.user.last_name  # Or however you want to get the name
