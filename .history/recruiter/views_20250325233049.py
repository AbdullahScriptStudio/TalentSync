...
def job_create_combined(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Create a new JobPost object and save the data
            job_post = JobPost(
            ...
            return redirect('job_post_success')  # Make sure 'job_post_success' is the correct URL name
 # You can change this to the actual success page or URL
