...
@csrf_exempt
import openai  # Ensure you have the correct API library installed
...
def chatbot_api(request):
    if request.method == "POST":
        ...
        # Simulate a chatbot response (Replace with actual OpenAI/Gemini API call)
        response_message = f"AI Response to: {user_message}"
