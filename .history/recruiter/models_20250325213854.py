...
class JobPost(models.Model):
    ...
    country = models.CharField(max_length=2, default=COUNTRY, editable=False)  # Fixed to 'DE' for Germany
    ...
    status = models.CharField(choices=JOB_STATUS, max_length=10, default='open')  # Job status field
