...
def job_create_step2(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            # Collect data from the session and store it for Step 2
            ...
            # Redirect to Step 3 after saving
            return redirect('job_create_step3')  # Make sure this points to the correct URL for Step 3
    else:
