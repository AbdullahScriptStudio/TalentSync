...
def job_create_combined(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Create and save the JobPost instance
            job_post = JobPost(
            ...
            job_post.save()  # Save the job post to the database

            # After successful save, redirect to a success page or another page
            return redirect('job_post_success')  # Replace with your desired URL
            
        else:
            # If the form is not valid, print the errors to help debug
    ...
    return render(request, 'recruiter/', {'form': form})
