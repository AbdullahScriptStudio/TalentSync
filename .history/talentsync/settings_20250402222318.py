"""
Django settings for talentsync project.
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # This allows Django to look inside each app's 'templates' directory
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'talentsync.wsgi.application'
